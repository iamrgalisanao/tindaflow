...
export const REPORTS = [
    ...
    {
        slug: 'gross-profit-by-product',
        title: 'Gross Profit by Product',
        description:
            'The same net sales, cost of goods sold and gross profit computation as Gross Profit, per product instead of per day. Only products with at least one sale in the window appear — see Product Velocity for a ranking that also includes never-sold products.',
        category: 'sales',
        filters: [dateRange('this_month')],
        summary: [
            { key: 'net_sales', label: 'Net sales', format: 'currency' },
        ...
        note: 'A row whose "Unknown cost" column is above zero has at least one sale line whose product had no cost on file at the time of sale -- that line costs nothing in this sum, so gross profit is overstated, not understated.',
        columns: [
            col('sku', 'SKU', 'mono_id'),
            col('product_name', 'Product', 'text'),
            col('quantity_sold', 'Qty sold', 'quantity', right),
        ...
        defaultSort: { key: 'gross_profit', dir: 'desc' },
        mobileMore: ['cost_of_goods_sold', 'gross_margin_percent', 'lines_with_unknown_cost'],
        moreLabel: 'cost detail',
        mobileEmphasis: 'gross_profit',
        exportPrefix: 'gross_profit_by_product',
    },
    {
        slug: 'product-velocity',
        title: 'Product Velocity',
        description:
            'Every product ranked by units sold, fastest first — including products with zero sales in the window, the true slow movers. No fast/slow label is applied; the ranking itself is the answer. Voided sales are excluded.',
        category: 'sales',
        filters: [dateRange('this_month')],
        summary: [{ key: 'net_sales', label: 'Net sales', format: 'currency' }],
        emptyState: {
            tone: 'ok',
            title: 'No products yet.',
            body: 'Add products in Catalog to see them ranked here.',
        },
        columns: [
            col('sku', 'SKU', 'mono_id'),
            col('product_name', 'Product', 'text'),
            col('quantity_sold', 'Qty sold', 'quantity', { ...right, sortable: true }),
            col('transaction_count', 'Txns', 'integer', right),
            col('net_sales', 'Net sales', 'currency', { ...right, total: 'money' }),
            col('quantity_on_hand', 'On hand', 'quantity', right),
        ],
        defaultSort: { key: 'quantity_sold', dir: 'desc' },
        mobileBadge: { key: 'quantity_sold', suffix: ' SOLD' },
        mobileMore: ['transaction_count', 'quantity_on_hand'],
        moreLabel: 'stock detail',
        mobileEmphasis: 'net_sales',
        exportPrefix: 'product_velocity',
    },
    {
        slug: 'gross-profit-by-category',
        title: 'Gross Profit by Category',
        description:
            'The same net sales, cost of goods sold and gross profit computation as Gross Profit, per merchandise category instead of per day. A product with no category groups under "Uncategorized".',
        category: 'sales',
        filters: [dateRange('this_month')],
        summary: [
            { key: 'net_sales', label: 'Net sales', format: 'currency' },
        ...
        note: 'A row whose "Unknown cost" column is above zero has at least one sale line whose product had no cost on file at the time of sale -- that line costs nothing in this sum, so gross profit is overstated, not understated.',
        columns: [
            col('category_name', 'Category', 'text', { value: (row) => row.category_name ?? 'Uncategorized' }),
            col('quantity_sold', 'Qty sold', 'quantity', right),
            col('net_sales', 'Net sales', 'currency', { ...right, total: 'money' }),
            col('cost_of_goods_sold', 'COGS', 'currency', { ...right, total: 'money' }),
            col('gross_profit', 'Gross profit', 'currency', { ...right, total: 'money' }),
        ...
        moreLabel: 'cost detail',
        mobileEmphasis: 'gross_profit',
        exportPrefix: 'gross_profit_by_category',
    },
    {
        slug: 'tax-breakdown',
